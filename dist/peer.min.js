!function o(s, a, u) {
    ...
    for (var p = "function" == typeof require && require, e = 0; e < u.length; e++)
        c(u[e]);
    return c
}({
    1: [function (e, t, i) {
        ...
        Object.defineProperty(i, "__esModule", {
            ...
            i.RTCSessionDescription = window.RTCSessionDescription || window.mozRTCSessionDescription,
            i.RTCPeerConnection = window.RTCPeerConnection || window.mozRTCPeerConnection || window.webkitRTCPeerConnection,
            i.RTCIceCandidate = window.RTCIceCandidate || window.mozRTCIceCandidate
    }
        , {}],
    2: [function (e, t, i) {
        "use strict";
        ...
        function s(e, t, i) {
            ...
            n.EventEmitter.call(this),
                ...
                this.peer = e,
                this.provider = t,
                this.id = this.options.connectionId || s._idPrefix + a.util.randomToken(),
                ...
                r.Negotiator.startConnection(this, this.options._payload || {
                    originator: !0
                })
        }
        i.DataConnection = s,
            a.util.inherits(s, n.EventEmitter),
            s._idPrefix = "dc_",
            s.prototype.initialize = function (e) {
                this._dc = this.dataChannel = e,
                    this._configureDataChannel()
            }
            ,
            s.prototype._configureDataChannel = function () {
                var t = this;
                a.util.supports.sctp && (this._dc.binaryType = "arraybuffer"),
                    this._dc.onopen = function () {
                        a.util.log("Data channel connection success"),
                            t.open = !0,
                            t.emit("open")
                    }
                    ,
                    !a.util.supports.sctp && this.reliable && (this._reliable = new o.Reliable(this._dc, a.util.debug)),
                    this._reliable ? this._reliable.onmessage = function (e) {
                        t.emit("data", e)
                    }
                    ...
                    this._dc.onclose = function (e) {
                        a.util.log("DataChannel closed for:", t.peer),
                            t.close()
                    }
            }
            ,
            s.prototype._handleDataMessage = function (e) {
                ...
                if ("binary" === this.serialization || "binary-utf8" === this.serialization) {
                    if (n === Blob)
                        return void a.util.blobToArrayBuffer(i, function (e) {
                            i = a.util.unpack(e),
                                t.emit("data", i)
                        });
                    if (n === ArrayBuffer)
                    ...
                    "json" === this.serialization && (i = JSON.parse(i));
                if (i.__peerData) {
                    var o = i.__peerData
                    ...
                    return s.data[i.n] = i.data,
                        s.count += 1,
                        s.total === s.count && (delete this._chunkedData[o],
                            i = new Blob(s.data),
                ...
                if (this.open)
                    if (this._reliable)
                        ...
                        if ("json" === this.serialization)
                            ...
                            var n = a.util.pack(e);
                            if ((a.util.chunkedBrowsers[this._peerBrowser] || a.util.chunkedBrowsers[a.util.browser]) && !t && n.size > a.util.chunkedMTU)
                ...
                switch (e.type) {
                    case "ANSWER":
                        this._peerBrowser = t.browser,
                            r.Negotiator.handleSDP(e.type, this, t.sdp);
                        break;
                    case "CANDIDATE":
    ...
    3: [function (e, t, i) {
        ...
        var r = e("./util")
            ...
            , p = e("./negotiator")
            , l = n(e("js-binarypack"));
        window.Socket = s.Socket,
            window.MediaConnection = a.MediaConnection,
            window.DataConnection = u.DataConnection,
            window.Peer = c.Peer,
            window.RTCPeerConnection = o.RTCPeerConnection,
            window.RTCSessionDescription = o.RTCSessionDescription,
            window.RTCIceCandidate = o.RTCIceCandidate,
            window.Negotiator = p.Negotiator,
            window.util = r.util,
            window.BinaryPack = l.default
    }
        , {
        "./adapter": 1,
        "./dataconnection": 2,
    ...
    4: [function (e, t, i) {
        ...
        function s(e, t, i) {
            ...
            n.EventEmitter.call(this),
                ...
                this.id = this.options.connectionId || s._idPrefix + r.util.randomToken(),
                this.localStream && o.Negotiator.startConnection(this, {
                    _stream: this.localStream,
                    originator: !0
                })
        }
        i.MediaConnection = s,
            r.util.inherits(s, n.EventEmitter),
            s._idPrefix = "mc_",
            s.prototype.addStream = function (e) {
                r.util.log("Receiving stream", e),
                    this.remoteStream = e,
                    this.emit("stream", e)
            }
            ,
            s.prototype.handleMessage = function (e) {
                ...
                switch (e.type) {
                    case "ANSWER":
                        o.Negotiator.handleSDP(e.type, this, t.sdp),
                            this.open = !0;
                        break;
                    case "CANDIDATE":
            ...
            s.prototype.answer = function (e) {
                if (this.localStream)
                    r.util.warn("Local stream already exists on this MediaConnection. Are you answering a call twice?");
                else {
                    this.options._payload._stream = e,
                        this.localStream = e,
                        o.Negotiator.startConnection(this, this.options._payload);
                    for (var t = this.provider._getMessages(this.id), i = 0, n = t.length; i < n; i += 1)
    ...
    5: [function (e, t, o) {
        ...
        o.Negotiator = {
            ...
            o.Negotiator._idPrefix = "pc_",
            o.Negotiator.startConnection = function (e, t) {
                var i = o.Negotiator._getPeerConnection(e, t);
                if (e.pc = e.peerConnection = i,
                    "media" === e.type && t._stream && i.addStream(t._stream),
                    t.originator) {
                    if ("data" === e.type) {
                        var n = {};
                    ...
                    o.Negotiator.handleSDP("OFFER", e, t.sdp)
            }
            ,
            o.Negotiator._getPeerConnection = function (e, t) {
                o.Negotiator.pcs[e.type] || s.util.error(e.type + " is not a valid connection type. Maybe you overrode the `type` property somewhere."),
                    o.Negotiator.pcs[e.type][e.peer] || (o.Negotiator.pcs[e.type][e.peer] = {});
                var i;
                o.Negotiator.pcs[e.type][e.peer];
                return t.pc && (i = o.Negotiator.pcs[e.type][e.peer][t.pc]),
                    i && "stable" === i.signalingState || (i = o.Negotiator._startPeerConnection(e)),
                    i
            }
            ,
            o.Negotiator._startPeerConnection = function (e) {
                ...
                return o.Negotiator.pcs[e.type][e.peer][t] = n,
                    o.Negotiator._setupListeners(e, n, t),
                    n
            }
            ,
            o.Negotiator._setupListeners = function (t, e, i) {
                var n = t.peer
                    , r = t.id
                    , o = t.provider;
                s.util.log("Listening for ICE candidates."),
                    e.onicecandidate = function (e) {
                        e.candidate && (s.util.log("Received ICE candidates for:", t.peer),
                            o.socket.send({
                                type: "CANDIDATE",
                                payload: {
                        ...
                        switch (e.iceConnectionState) {
                            case "failed":
                                s.util.log("iceConnectionState is disconnected, closing connections to " + n),
                                    t.emit("error", new Error("Negotiation of connection to " + n + " failed.")),
                                    t.close();
                                break;
                            case "disconnected":
                                s.util.log("iceConnectionState is disconnected, closing connections to " + n),
                    ...
                    ,
                    e.onicechange = e.oniceconnectionstatechange,
                    s.util.log("Listening for data channel"),
                    ...
                    ,
                    s.util.log("Listening for remote stream"),
            ...
            o.Negotiator.cleanup = function (e) {
                ...
                var t = e.pc;
                t && (t.readyState && "closed" !== t.readyState || "closed" !== t.signalingState) && (t.close(),
                    e.pc = null)
            }
            ,
            o.Negotiator._makeOffer = function (t) {
                ...
                i.createOffer(function (e) {
                    s.util.log("Created offer."),
                        !s.util.supports.sctp && "data" === t.type && t.reliable && (e.sdp = Reliable.higherBandwidthSDP(e.sdp)),
                        i.setLocalDescription(e, function () {
                            s.util.log("Set localDescription: offer", "for:", t.peer),
                                t.provider.socket.send({
                                    type: "OFFER",
                                    payload: {
                                        sdp: e,
                                        type: t.type,
                            ...
                            "OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer" != e && (t.provider.emitError("webrtc", e),
                                s.util.log("Failed to setLocalDescription, ", e))
                        })
                }, function (e) {
                    t.provider.emitError("webrtc", e),
                        s.util.log("Failed to createOffer, ", e)
            ...
            o.Negotiator._makeAnswer = function (t) {
                ...
                i.createAnswer(function (e) {
                    s.util.log("Created answer."),
                        !s.util.supports.sctp && "data" === t.type && t.reliable && (e.sdp = Reliable.higherBandwidthSDP(e.sdp)),
                        i.setLocalDescription(e, function () {
                            s.util.log("Set localDescription: answer", "for:", t.peer),
                                t.provider.socket.send({
                                    type: "ANSWER",
                                    payload: {
                                        sdp: e,
                    ...
                    t.provider.emitError("webrtc", e),
                        s.util.log("Failed to create answer, ", e)
                })
            }
            ,
            o.Negotiator.handleSDP = function (e, t, i) {
                ...
                var n = t.pc;
                s.util.log("Setting remote description", i),
                    n.setRemoteDescription(i, function () {
                        s.util.log("Set remoteDescription:", e, "for:", t.peer),
                            "OFFER" === e && o.Negotiator._makeAnswer(t)
                    }, function (e) {
                        t.provider.emitError("webrtc", e),
                            s.util.log("Failed to setRemoteDescription, ", e)
                    })
            }
            ,
    ...
    6: [function (e, t, i) {
        ...
        function o(e, t) {
            if (!(this instanceof o))
                return new o(e, t);
            n.EventEmitter.call(this),
                e && e.constructor == Object ? (t = e,
                    e = void 0) : e && (e = e.toString()),
                (t = p.util.extend({
                    debug: 0,
                ...
                "/" === (this.options = t).host && (t.host = window.location.hostname),
                "/" !== t.path[0] && (t.path = "/" + t.path),
                "/" !== t.path[t.path.length - 1] && (t.path += "/"),
                void 0 === t.secure && t.host !== p.util.CLOUD_HOST ? t.secure = p.util.isSecure() : t.host == p.util.CLOUD_HOST && (t.secure = !0),
                t.logFunction && p.util.setLogFunction(t.logFunction),
                p.util.setLogLevel(t.debug),
                p.util.supports.audioVideo || p.util.supports.data ? p.util.validateId(e) ? (this.destroyed = !1,
                    this.disconnected = !1,
                    this.open = !1,
                    this.connections = {},
                    this._lostMessages = {},
                    this._initializeServerConnection(),
                    e ? this._initialize(e) : this._retrieveId()) : this._delayedAbort("invalid-id", 'ID "' + e + '" is invalid') : this._delayedAbort("browser-incompatible", "The current browser does not support WebRTC")
        }
        i.Peer = o,
            p.util.inherits(o, n.EventEmitter),
            o.prototype._initializeServerConnection = function () {
                var t = this;
                this.socket = new r.Socket(this.options.secure, this.options.host, this.options.port, this.options.path, this.options.key, this.options.wsport),
                    ...
                    this.socket.on("disconnected", function () {
                        t.disconnected || (t.emitError("network", "Lost connection to server."),
                            t.disconnect())
                    }),
            ...
            o.prototype._retrieveId = function (e) {
                ...
                n += "?ts=" + (new Date).getTime() + Math.random(),
                    t.open("get", n, !0),
                    t.onerror = function (e) {
                        p.util.error("Error retrieving ID", e);
                        var t = "";
                        "/" === i.options.path && i.options.host !== p.util.CLOUD_HOST && (t = " If you passed in a `path` to your self-hosted PeerServer, you'll also need to pass in that same path when creating a new Peer."),
                            i._abort("server-error", "Could not get an ID from the server." + t)
                    }
                    ,
            ...
            o.prototype._handleMessage = function (e) {
                var t, i = e.type, n = e.payload, r = e.src;
                switch (i) {
                    case "OPEN":
                    ...
                    case "INVALID-KEY":
                        ...
                        break;
                    case "LEAVE":
                        p.util.log("Received leave message from", r),
                            this._cleanupPeer(r);
                        break;
                    case "EXPIRE":
                    ...
                    case "OFFER":
                        ...
                        if ((t = this.getConnection(r, o)) && (t.close(),
                            p.util.warn("Offer received for existing Connection ID:", o)),
                            "media" === n.type)
                            t = new l.MediaConnection(r, this, {
                                connectionId: o,
                                _payload: n,
                                metadata: n.metadata
                            }),
                            ...
                            if ("data" !== n.type)
                                return void p.util.warn("Received malformed connection type:", n.type);
                        ...
                        for (var s = this._getMessages(o), a = 0, u = s.length; a < u; a += 1)
                            t.handleMessage(s[a]);
                        break;
                    default:
                        if (!n)
                            return void p.util.warn("You received a malformed message from " + r + " of type " + i);
            ...
            o.prototype._storeMessage = function (e, t) {
                this._lostMessages[e] || (this._lostMessages[e] = []),
                    this._lostMessages[e].push(t)
            }
            ,
            o.prototype._getMessages = function (e) {
                var t = this._lostMessages[e];
                return t ? (delete this._lostMessages[e],
                    t) : []
            }
            ,
            o.prototype.connect = function (e, t) {
                if (this.disconnected)
                    return p.util.warn("You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect, or call reconnect on this peer if you believe its ID to still be available."),
                        void this.emitError("disconnected", "Cannot connect to new Peer after disconnecting from server.");
                var i = new h.DataConnection(e, this, t);
                return this._addConnection(e, i),
                    i
            }
            ,
            o.prototype.call = function (e, t, i) {
                if (this.disconnected)
                    return p.util.warn("You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect."),
                        void this.emitError("disconnected", "Cannot connect to new Peer after disconnecting from server.");
                if (t) {
                    (i = i || {})._stream = t;
            ...
            o.prototype._cleanup = function () {
                if (this.connections)
                    for (var e = Object.keys(this.connections), t = 0, i = e.length; t < i; t++)
                        this._cleanupPeer(e[t]);
                this.emit("close")
            }
            ,
            o.prototype._cleanupPeer = function (e) {
                for (var t = this.connections[e], i = 0, n = t.length; i < n; i += 1)
                    t[i].close()
            }
            ,
            o.prototype.disconnect = function () {
                var e = this;
                p.util.setZeroTimeout(function () {
                    e.disconnected || (e.disconnected = !0,
                        e.open = !1,
            ...
            o.prototype.reconnect = function () {
                if (this.disconnected && !this.destroyed)
                    p.util.log("Attempting reconnection to server with ID " + this._lastServerId),
                        this.disconnected = !1,
                        this._initializeServerConnection(),
            ...
            o.prototype.listAllPeers = function (t) {
                ...
                e += "?ts=" + (new Date).getTime() + Math.random(),
                    n.open("get", e, !0),
                    n.onerror = function (e) {
                        i._abort("server-error", "Could not get peers from the server."),
                            t([])
                    }
                    ,
                    n.onreadystatechange = function () {
                        if (4 === n.readyState) {
                            if (401 === n.status) {
                                var e = "";
                                throw e = i.options.host !== p.util.CLOUD_HOST ? "It looks like you're using the cloud server. You can email team@peerjs.com to enable peer listing for your API key." : "You need to enable `allow_discovery` on your self-hosted PeerServer to use this feature.",
                                t([]),
                                new Error("It doesn't look like you have permission to list peers IDs. " + e)
                            }
    ...
    7: [function (e, t, i) {
        ...
        function c(e, t, i, n, r, o) {
            ...
            var s = e ? "https://" : "http://"
                , a = e ? "wss://" : "ws://";
            this._httpUrl = s + t + ":" + i + n + r,
                this._wsUrl = a + t + ":" + o + n + "peerjs?key=" + r
        }
        i.Socket = c,
            o.util.inherits(c, u.EventEmitter),
            ...
            c.prototype._startWebSocket = function (e) {
                var i = this;
                this._socket || (this._socket = new WebSocket(this._wsUrl),
                ...
                try {
                    ...
                    this._http = new XMLHttpRequest,
                        ...
                        this._http.onreadystatechange = function () {
                            2 == this.readyState && this.old ? (this.old.abort(),
                                delete this.old) : 2 < this.readyState && 200 === this.status && this.responseText && t._handleStream(this)
                        }
                        ,
            ...
            c.prototype._setHTTPTimeout = function () {
                ...
                this._timeout = setTimeout(function () {
                    var e = t._http;
                    t._wsOpen() ? e.abort() : (t._startXhrStream(e._streamIndex + 1),
                        t._http.old = e)
                }, 25e3)
            }
            ,
            ...
            c.prototype._sendQueuedMessages = function () {
                for (var e = 0, t = this._queue.length; e < t; e += 1)
                    this.send(this._queue[e])
            }
            ,
            ...
            c.prototype.close = function () {
                !this.disconnected && this._wsOpen() && (this._socket.close(),
                    this.disconnected = !0)
            }
    }
        , {
    ...
    8: [function (e, t, c) {
            ...
            iceServers: [
                {
                    ...
                    username: "Uf1V-eVf32ElaFwL60I3fDB96naJKjBGSnFdXTrovxR3R4rQRcXy1AqcRuRBpqwLAAAAAFy6xjdldHVpdG9y",
                    credential: "91f01b06-633b-11e9-83e8-322c48b34491",
                },
                {
        ...
        c.util = {
            ...
            setLogLevel: function (e) {
                var t = parseInt(e, 10);
                isNaN(parseInt(e, 10)) ? c.util.logLevel = e ? 3 : 0 : c.util.logLevel = t,
                    c.util.log = c.util.warn = c.util.error = c.util.noop,
                    0 < c.util.logLevel && (c.util.error = c.util._printWith("ERROR")),
                    1 < c.util.logLevel && (c.util.warn = c.util._printWith("WARNING")),
                    2 < c.util.logLevel && (c.util.log = c.util._print)
            },
            ...
            _print: function () {
                ...
                for (var i = 0, n = t.length; i < n; i++)
                    t[i] instanceof Error && (t[i] = "(" + t[i].name + ") " + t[i].message,
                        e = !0);
            ...
            supports: function () {
                if (void 0 === l.RTCPeerConnection)
                    return {};
                var e, t, i = !0, n = !0, r = !1, o = !1, s = !!window.webkitRTCPeerConnection;
                try {
            ...
            setZeroTimeout: function (t) {
                ...
                function e(e) {
                    e.source == t && e.data == n && (e.stopPropagation && e.stopPropagation(),
                        i.length && i.shift()())
                }
    ...
    9: [function (e, t, i) {
        ...
        n.prototype._events = void 0,
            n.prototype.listeners = function (e) {
                ...
                for (var t = 0, i = this._events[e].length, n = new Array(i); t < i; t++)
                    n[t] = this._events[e][t].fn;
                return n
            }
            ,
            n.prototype.emit = function (e, t, i, n, r, o) {
                if (!this._events || !this._events[e])
                    return !1;
                var s, a, u = this._events[e], c = arguments.length;
                if ("function" == typeof u.fn) {
                    switch (u.once && this.removeListener(e, u.fn, !0),
                    c) {
                        case 1:
                        ...
                        case 3:
                            return u.fn.call(u.context, t, i),
                                !0;
                        case 4:
                            return u.fn.call(u.context, t, i, n),
                                !0;
                        case 5:
                            return u.fn.call(u.context, t, i, n, r),
                                !0;
                        case 6:
                            return u.fn.call(u.context, t, i, n, r, o),
                                !0
                    }
                    for (a = 1,
                        s = new Array(c - 1); a < c; a++)
                        s[a - 1] = arguments[a];
                    u.fn.apply(u.context, s)
                } else {
                    var p, l = u.length;
                    for (a = 0; a < l; a++)
                        switch (u[a].once && this.removeListener(e, u[a].fn, !0),
                        c) {
                            case 1:
            ...
            n.prototype.on = function (e, t, i) {
                ...
                return this._events || (this._events = {}),
                    this._events[e] ? this._events[e].fn ? this._events[e] = [this._events[e], n] : this._events[e].push(n) : this._events[e] = n,
                    this
            }
            ,
            ...
            n.prototype.removeListener = function (e, t, i) {
                ...
                var n = this._events[e]
                    , r = [];
                if (t && (n.fn && (n.fn !== t || i && !n.once) && r.push(n),
                    !n.fn))
                    for (var o = 0, s = n.length; o < s; o++)
                        (n[o].fn !== t || i && !n[o].once) && r.push(n[o]);
                return r.length ? this._events[e] = 1 === r.length ? r[0] : r : delete this._events[e],
                    this
            }
            ,
            n.prototype.removeAllListeners = function (e) {
                return this._events && (e ? delete this._events[e] : this._events = {}),
                    this
            }
            ,
            ...
            ,
            ((n.EventEmitter = n).EventEmitter2 = n).EventEmitter3 = n,
            t.exports = n
    }
        , {}],
    10: [function (e, t, i) {
        ...
        t.exports = o,
            ...
            s.prototype.unpack_string = function (e) {
                for (var t, i, n = this.read(e), r = 0, o = ""; r < e;)
                    (t = n[r]) < 128 ? (o += String.fromCharCode(t),
                        r++) : (192 ^ t) < 32 ? (i = (192 ^ t) << 6 | 63 & n[r + 1],
                            o += String.fromCharCode(i),
                            r += 2) : (i = (15 & t) << 12 | (63 & n[r + 1]) << 6 | 63 & n[r + 2],
                                o += String.fromCharCode(i),
                                r += 3);
                return this.index += e,
                    o
            ...
            a.prototype.pack = function (e) {
                ...
                if ("string" == t)
                    ...
                    if (null === e)
                        ...
                        if (i == Array)
                            this.pack_array(e);
                        else if (i == Blob || i == File)
                            this.pack_bin(e);
                        else if (i == ArrayBuffer)
                            r.useArrayBufferView ? this.pack_bin(new Uint8Array(e)) : this.pack_bin(e);
                        else if ("BYTES_PER_ELEMENT" in e)
                            r.useArrayBufferView ? this.pack_bin(new Uint8Array(e.buffer)) : this.pack_bin(e.buffer);
                        else if (i == Object)
                            this.pack_object(e);
                        else if (i == Date)
                            ...
                            if ("function" != typeof e.toBinaryPack)
                                throw new Error('Type "' + i.toString() + '" not yet supported');
            ...
            a.prototype.pack_object = function (e) {
                ...
                for (var i in e)
                    e.hasOwnProperty(i) && (this.pack(i),
                        this.pack(e[i]))
            }
            ,
    ...
    11: [function (e, t, i) {
        ...
        "undefined" != typeof window && (r = t.exports.BlobBuilder = window.WebKitBlobBuilder || window.MozBlobBuilder || window.MSBlobBuilder || window.BlobBuilder),
            ...
            o.prototype.getBuffer = function () {
                if (this.flush(),
                    n.useBlobBuilder) {
                    for (var e = new r, t = 0, i = this._parts.length; t < i; t++)
    ...
    12: [function (e, t, i) {
        ...
        n.prototype.send = function (e) {
            ...
            t.size < this._mtu ? this._handleSend(["no", t]) : (this._outgoing[this._count] = {
                ...
                c.debug && (this._outgoing[this._count].timer = new Date),
            ...
            n.prototype._intervalSend = function (e) {
                var t = this;
                e = c.pack(e),
                    c.blobToBinaryString(e, function (e) {
                        t._dc.send(e)
                    }),
                    0 === t._queue.length && (clearTimeout(t._timeout),
                        t._timeout = null)
            }
            ,
            ...
            n.prototype._handleSend = function (e) {
                ...
                t && (this._queue.push(e),
                    this._timeout || this._setupInterval())
            }
            ,
            ...
            n.prototype._handleMessage = function (e) {
                var t, i = e[1], n = this._incoming[i], r = this._outgoing[i];
                switch (e[0]) {
                    case "no":
                        var o = i;
                    ...
                    case "ack":
                        if (t = r) {
                            var s = e[2];
                            t.ack = Math.max(s, t.ack),
                                t.ack >= t.chunks.length ? (c.log("Time: ", new Date - t.timer),
                                    delete this._outgoing[i]) : this._processAcks()
                        }
                        break;
                    case "chunk":
                        if (!(t = n)) {
                            if (!0 === this._received[i])
                                break;
                            t = {
                                ack: ["ack", i, 0],
                                chunks: []
                        ...
                        var a = e[2]
                            , u = e[3];
                        t.chunks[a] = new Uint8Array(u),
                            a === t.ack[2] && this._calculateNextAck(i),
                            this._ack(i);
                        break;
                    default:
                        this._handleSend(e)
            ...
            n.prototype._chunk = function (e) {
                ...
                return c.log("Created", t.length, "chunks."),
                    t
            }
            ,
            n.prototype._ack = function (e) {
                var t = this._incoming[e].ack;
                this._received[e] === t[2] && (this._complete(e),
                    this._received[e] = !0),
                    this._handleSend(t)
            }
            ,
            n.prototype._calculateNextAck = function (e) {
                for (var t = this._incoming[e], i = t.chunks, n = 0, r = i.length; n < r; n += 1)
                    if (void 0 === i[n])
                        return void (t.ack[2] = n);
                t.ack[2] = i.length
            }
            ,
            n.prototype._sendWindowedChunks = function (e) {
                c.log("sendWindowedChunks for: ", e);
                for (var t = this._outgoing[e], i = t.chunks, n = [], r = Math.min(t.ack + this._window, i.length), o = t.ack; o < r; o += 1)
                    i[o].sent && o !== t.ack || (i[o].sent = !0,
                        n.push(["chunk", e, o, i[o].payload]));
                t.ack + this._window >= i.length && n.push(["end", e, i.length]),
                    n._multiple = !0,
                    this._handleSend(n)
            }
            ,
